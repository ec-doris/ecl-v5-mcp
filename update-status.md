...
**Batch 17: modal, popover and notification interaction.**
...
their paired helpers and runtime behavior. Next, take modal, popover and
notification as a focused interaction batch. Keep the inpage-navigation
decision visible; GUIDE-assets and GUIDE-icons WebTools rendering remain
pending.
...
Suggested following order after Batch 15 (adjust for dependencies and user focus):

1. Modal, popover and notification, including their paired helpers and browser
