...
- Last tracker update: 2026-07-16
...
- Next component: none
- Next action: all inventory rows are completed; choose a new baseline or scope before starting another component pass
- Evidence and warnings: `video` completed 2026-07-16. Preflight passed: `europa-component-library` is a symlink, tag `v5.0.1` resolves to `eceefe9468e44f7ce9c57801c91c4c0c057548b4`, outer status showed no output before this pass's tracker edit, and linked checkout status output was empty. Tagged source lists README, package metadata, SCSS, Twig, tests, snapshots, and demo data; no JavaScript runtime, print SCSS, story, or EC website API/code/usage/accessibility docs were listed by preflight. Upstream audit completed: Twig always renders one `video.ecl-video` root, starts attributes with valueless `playsinline`, defaults `controls` to true, conditionally adds `poster`, `aria-label`, `controls`, `autoplay`, `muted`, `loop`, `ecl-video--zoom`, root `extra_classes`, and valued or valueless `extra_attributes`. `aria-label` is emitted only when `title` is non-empty; when title and both screen-reader labels are present, `sr_video_label` wins over `sr_video_player`, and screen-reader labels alone render no label. Each source and track item renders even if individual fields are empty, producing empty `source` or `track` elements as the tagged contract. README documents poster, controls, autoplay, muted, loop, zoom, screen-reader labels, sources, tracks, and extension hooks. Snapshots cover default, autoplay/muted/loop, extra classes, and valued extra attributes. Compiled CSS contains `ecl-video` and `ecl-video--zoom`; print CSS has no video selectors. Compiled JS contains no video-specific runtime, hooks, or auto-init. Coverage ledger completed: examples cover default source/poster/title player label; multiple sources and tracks; boolean controls false plus autoplay/muted/loop; zoom plus extra class and valued/valueless attributes; source and track partial-field branches; title plus item label precedence; no-title/no-label branch; tagged empty root output; and all 15 non-default EC color modes as compact root-class examples. No runtime hooks or auto-init attributes are authored because v5.0.1 has none. Validation passed: Twig identity, no-Twig HTML, Prettier check, structural/ID check, color-mode set check, focused selector/runtime/source/track checks, package dry-run inclusion, authored-file trailing whitespace check, Jest smoke with `--passWithNoTests`, JS syntax checks for both compiled bundles, and `git diff --check`. The npm pack `.gitignore` fallback warning and Jest no-tests result are expected. Laravel full-suite testing was not applicable because this repository has no `composer.json` or `artisan`.
...
| ordered-list        | `components/ordered-list.html`        | `components/ordered-list.html.twig`                                                                                         | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers text/link/nested branches, variants, extension hooks, empty output, no-runtime evidence, and all 15 non-default color modes.                                                       |
| page-header         | `components/page-header.html`         | `components/page-header.html.twig`, `components/page-header-expandable.html.twig`                                           | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers layout, media, content, meta, expandable runtime hooks, edge output, extension hooks, and all 15 non-default color modes.                                                          |
| page-information    | `components/page-information.html`    | `components/page-information.html.twig`                                                                                     | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers content, empty output, free HTML/link content, extension hooks, no-runtime evidence, and all 15 non-default color modes.                                                           |
| page-summary        | `components/page-summary.html`        | `components/page-summary.html.twig`                                                                                         | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers title/icon/description/list branches, extension hooks, excludes invalid title-absent upstream outputs, and all 15 non-default color modes.                                         |
| pagination          | `components/pagination.html`          | `components/pagination.html.twig`                                                                                           | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers link/text/current/truncation branches, extension hooks, empty outputs, no-runtime evidence, and all 15 non-default color modes.                                                    |
| picture             | `components/picture.html`             | `components/picture.html.twig`                                                                                              | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers source/image branches, modifiers, extension hooks, edge outputs, no-runtime evidence, and all 15 modes.                                                                            |
| popover             | `components/popover.html`             | `components/popover.html.twig`                                                                                              | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers toggle/content/close/extension/runtime branches, authored placement states, and all 15 non-default color modes.                                                                    |
| quiz                | `components/quiz.html`                | `components/quiz.html.twig`, `components/quiz-card.html.twig`                                                               | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers poll/reveal card shapes, extension/runtime hooks, full-width/background branches, one hardcoded-dot-template root, and all 15 modes.                                               |
| radio               | `components/radio.html`               | `components/radio-group.html.twig`, `components/radio-button.html.twig`                                                     | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers group propagation, button states, helper text, extension hooks, empty output, no-runtime evidence, and all 15 non-default color modes.                                             |
| range               | `components/range.html`               | `components/range.html.twig`                                                                                                | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers runtime hooks, states, widths, extension hooks, excludes invalid no-value IDREF output, and all 15 non-default color modes.                                                        |
| rating-field        | `components/rating-field.html`        | `components/rating-field.html.twig`                                                                                         | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers rating states, labels, empty output, unused upstream inputs, no-runtime evidence, and all 15 non-default color modes.                                                              |
| search-form         | `components/search-form.html`         | `components/search-form.html.twig`                                                                                          | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers form/input/button branches, extension hooks, extra form elements, disabled state, placeholder-label fallback, no-runtime evidence, and all 15 non-default color modes.             |
| select              | `components/select.html`              | `components/select.html.twig`                                                                                               | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers select states, optgroups, multiple hooks, extension attributes, runtime exclusions, and all 15 non-default color modes.                                                            |
| separator           | `components/separator.html`           | `components/separator.html.twig`                                                                                            | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers default, extra classes, valued/valueless extension attributes, story list context, no-runtime evidence, and all 15 non-default color modes.                                        |
| site-footer         | `components/site-footer.html`         | `components/site-footer-ec.html.twig`, `components/site-footer-ec-section.html.twig`, `components/site-footer-eu.html.twig` | completed     | Completed 2026-07-15 against v5.0.1. Twig is exact; HTML covers EC/EU footer branches, extension hooks, no-runtime evidence, tagged empty outputs, and all 15 non-default color modes. EC preset CSS lacks EU-only selector rules, recorded above. |
| site-header         | `components/site-header.html`         | `components/site-header.html.twig`, `components/site-header-language-switcher.html.twig`                                    | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers root hooks, action/login/language/search/notification/banner/menu branches, runtime hooks, edge output, and all 15 non-default color modes.                                        |
| skip-link           | `components/skip-link.html`           | `components/skip-link.html.twig`                                                                                            | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers default, empty output, extension hooks, no-runtime evidence, delegated primary link output, and all 15 non-default color modes.                                                    |
| slogan-ticker       | `components/slogan-ticker.html`       | `components/slogan-ticker.html.twig`                                                                                        | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers items, controls, autoplay, color mode, extension hooks, empty output, runtime hooks, and all 15 non-default color modes.                                                           |
| social-media-follow | `components/social-media-follow.html` | `components/social-media-follow.html.twig`                                                                                  | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers layout/position/description/link/extension branches, empty outputs, no-runtime evidence, and all 15 non-default color modes.                                                       |
| spinner             | `components/spinner.html`             | `components/spinner.html.twig`                                                                                              | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers variants, sizes, text, centering, visibility, overlay, extra attributes, empty output, upstream extra-class omission, no-runtime evidence, and all 15 non-default color modes.     |
| splash-page         | `components/splash-page.html`         | `components/splash-page.html.twig`                                                                                          | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers logo/language/content branches, extension hooks, count modifiers, edge output, no-runtime evidence, and all 15 non-default color modes.                                            |
| spotlight           | `components/spotlight.html`           | `components/spotlight.html.twig`                                                                                            | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers image/link/header/title/credit/anchor/full-width/font/extension branches, no-runtime evidence, and all 15 non-default color modes.                                                 |
| table               | `components/table.html`               | `components/table.html.twig`                                                                                                | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers default/simple/zebra/multi/sortable shapes, extension hooks, edge outputs, runtime exclusions, and all 15 modes.                                                                   |
| tabs                | `components/tabs.html`                | `components/tabs.html.twig`                                                                                                 | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers default/content/extension branches, runtime hooks and exclusions, edge output comments, and all 15 non-default modes.                                                              |
| tag                 | `components/tag.html`                 | `components/tag.html.twig`, `components/tag-set.html.twig`                                                                  | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers link/removable/tag-set variants, extension hooks, color propagation and overrides, empty set output, and all 15 non-default color modes.                                           |
| text-area           | `components/text-area.html`           | `components/text-area.html.twig`                                                                                            | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers widths, value/name, states, extension hooks, empty optional output, runtime exclusions, and all 15 non-default color modes.                                                        |
| text-input          | `components/text-input.html`          | `components/text-input.html.twig`                                                                                           | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers widths, types, states, extension hooks, empty optional output, runtime exclusions, and all 15 non-default color modes.                                                             |
| text-media          | `components/text-media.html`          | `components/text-media.html.twig`                                                                                           | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers media/content/layout/link/extension branches, delegated media-container hooks, empty output, runtime exclusions, and all 15 non-default color modes.                               |
| timeline            | `components/timeline.html`            | `components/timeline.html.twig`, `components/timeline-set.html.twig`                                                        | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers timeline/set branches, hide/toggle variants, extension hooks, runtime hooks, empty output, and all 15 non-default color modes.                                                     |
| tooltip             | `components/tooltip.html`             | n/a (no upstream Twig template)                                                                                             | completed     | Completed 2026-07-16 against v5.0.1. HTML covers story-authored default/inverted triggers, title fallback, runtime hooks and exclusions, empty-content edge case, and all 15 non-default color modes.                                              |
| unordered-list      | `components/unordered-list.html`      | `components/unordered-list.html.twig`                                                                                       | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers text/link labels, divider/no-marker variants, extension hooks, empty output, no-runtime evidence, nested default output, and all 15 non-default color modes.                       |
| video               | `components/video.html`               | `components/video.html.twig`                                                                                                | completed     | Completed 2026-07-16 against v5.0.1. Twig is exact; HTML covers source/track branches, media booleans, labels, extension hooks, empty root output, no-runtime evidence, and all 15 non-default color modes.                                        |
