...
- Last tracker update: 2026-07-14
...
- Status: ready
- Phase: none
- Last completed: `breadcrumb`
- Next component: `card`
- Next action: change `card` to `started` here before auditing its tagged v5.0.1 source or editing its files
- Evidence and warnings: Breadcrumb completed 2026-07-14. `components/breadcrumb.html.twig` is byte-identical to `v5.0.1:src/components/breadcrumb/breadcrumb.html.twig` and SHA-256 `a2edcd1d8a916b2f1f7c474dc06176579ffe8d554ee0c157de4be3e8635216b5`; reusable HTML SHA-256 `4b8370901d425e4262be1ec3fc98a033ac1199ea7832bc6c9c7d1581f7adde91` has no Twig and covers the audited ledger: empty/root-only output, single item, two-item mobile branch, simple static breadcrumb, long auto-init breadcrumb, ellipsis/button/icon hooks, expandable/static item split, custom `min_items_left`/`min_items_right`, custom `navigation_text`, custom `ellipsis_label`, custom `ellipsis_text`, extra classes, valued and valueless attributes, and all 15 non-default EC color modes. Runtime-only `data-ecl-auto-initialized`, `ecl-breadcrumb--collapsed`, `ecl-breadcrumb--wrap`, and JS-computed item `aria-hidden` states are intentionally excluded. Validation passed: Twig identity, no-Twig HTML, Prettier check, structural/IDREF check, color-mode set diff, focused Breadcrumb hook/class/runtime-exclusion assertions, JS syntax checks, Jest smoke with `--passWithNoTests`, package dry-run inclusion, and `git diff --check`. The initial `npm test -- --runInBand` exit 1 is expected because this repository has no Jest tests; the npm pack `.gitignore` fallback warning is expected. The old static-only `ecl-link--standalone` class was removed because tagged v5.0.1 Breadcrumb snapshots render links as `ecl-link ecl-breadcrumb__link`.
...
| card                | `components/card.html`                | `components/card.html.twig`                                                                                                 | not started   |                                                                                                                                                                                                                                           |
| carousel            | `components/carousel.html`            | `components/carousel.html.twig`                                                                                             | not started   |                                                                                                                                                                                                                                           |
| category-filter     | `components/category-filter.html`     | `components/category-filter.html.twig`, `components/category-filter-items.html.twig`                                        | not started   |                                                                                                                                                                                                                                           |
| checkbox            | `components/checkbox.html`            | `components/checkbox-group.html.twig`, `components/checkbox-item.html.twig`                                                 | not started   |                                                                                                                                                                                                                                           |
| content-block       | `components/content-block.html`       | `components/content-block.html.twig`                                                                                        | not started   |                                                                                                                                                                                                                                           |
| content-item        | `components/content-item.html`        | `components/content-item.html.twig`                                                                                         | not started   |                                                                                                                                                                                                                                           |
| date-block          | `components/date-block.html`          | `components/date-block.html.twig`                                                                                           | not started   |                                                                                                                                                                                                                                           |
| datepicker          | `components/datepicker.html`          | `components/datepicker.html.twig`                                                                                           | not started   |                                                                                                                                                                                                                                           |
| description-list    | `components/description-list.html`    | `components/description-list.html.twig`                                                                                     | not started   |                                                                                                                                                                                                                                           |
| expandable          | `components/expandable.html`          | `components/expandable.html.twig`                                                                                           | not started   |                                                                                                                                                                                                                                           |
| fact-figures        | `components/fact-figures.html`        | `components/fact-figures.html.twig`                                                                                         | not started   |                                                                                                                                                                                                                                           |
| featured-item       | `components/featured-item.html`       | `components/featured-item.html.twig`                                                                                        | not started   |                                                                                                                                                                                                                                           |
| file                | `components/file.html`                | `components/file.html.twig`, `components/file-translations.html.twig`, `components/file-translation-item.html.twig`         | not started   |                                                                                                                                                                                                                                           |
| file-upload         | `components/file-upload.html`         | `components/file-upload.html.twig`                                                                                          | not started   |                                                                                                                                                                                                                                           |
| form-group          | `components/form-group.html`          | `components/form-group.html.twig`                                                                                           | not started   |                                                                                                                                                                                                                                           |
| gallery             | `components/gallery.html`             | `components/gallery.html.twig`, `components/gallery-item.html.twig`, `components/gallery-overlay.html.twig`                 | not started   |                                                                                                                                                                                                                                           |
| highlight-box       | missing                               | missing (`highlight-box.html.twig`)                                                                                         | not started   |                                                                                                                                                                                                                                           |
| icon                | `components/icon.html`                | `components/icon.html.twig`                                                                                                 | not started   |                                                                                                                                                                                                                                           |
| indicator           | `components/indicator.html`           | `components/indicator.html.twig`                                                                                            | not started   |                                                                                                                                                                                                                                           |
| inpage-navigation   | `components/inpage-navigation.html`   | `components/inpage-navigation.html.twig`                                                                                    | not started   |                                                                                                                                                                                                                                           |
| label               | `components/label.html`               | `components/label.html.twig`                                                                                                | not started   |                                                                                                                                                                                                                                           |
| link                | `components/link.html`                | `components/link.html.twig`                                                                                                 | not started   |                                                                                                                                                                                                                                           |
| list-illustration   | `components/list-illustration.html`   | `components/list-illustration.html.twig`, `components/list-illustration-item.html.twig`                                     | not started   |                                                                                                                                                                                                                                           |
| media-container     | `components/media-container.html`     | `components/media-container.html.twig`                                                                                      | not started   |                                                                                                                                                                                                                                           |
| mega-menu           | missing                               | missing (`mega-menu.html.twig`, `mega-menu-item.html.twig`, `mega-menu-featured-item.html.twig`)                            | not started   |                                                                                                                                                                                                                                           |
| menu                | `components/menu.html`                | `components/menu.html.twig`, `components/menu-item.html.twig`                                                               | not started   |                                                                                                                                                                                                                                           |
| modal               | `components/modal.html`               | `components/modal.html.twig`                                                                                                | not started   |                                                                                                                                                                                                                                           |
| navigation-list     | `components/navigation-list.html`     | `components/navigation-list.html.twig`, `components/navigation-list-item.html.twig`                                         | not started   |                                                                                                                                                                                                                                           |
| news-ticker         | `components/news-ticker.html`         | `components/news-ticker.html.twig`                                                                                          | not started   |                                                                                                                                                                                                                                           |
| notification        | `components/notification.html`        | `components/notification.html.twig`                                                                                         | not started   |                                                                                                                                                                                                                                           |
